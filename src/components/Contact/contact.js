...
const Contact = () => {
  ...
  const EMAILJS_SERVICE_ID = "service_5w3p19b"; // Your Service ID
  const EMAILJS_ADMIN_TEMPLATE_ID = "template_ls3gs5r"; // Your Template ID for emails TO YOU
  // VVVV IMPORTANT: Create a NEW template in EmailJS for auto-response TO USER VVVV
  const EMAILJS_USER_AUTORESPONSE_TEMPLATE_ID = "template_bbdj2h1"; // <<== Aapki sahi user auto-response ID
  const EMAILJS_PUBLIC_KEY = "GjqO6miCUb2Vma1Wl"; // Your Public Key
    ...
    <section id="contact" className="contactPage">
      ...
      <div className="contactContentWrapper">
        ...
        <div className="links">
          ...
          {/* GitHub Link */}
          <a
            href="https://github.com/ImadEhsan"
            target="_blank"
          ...
          {/* LinkedIn Link */}
          <a
            href="https://www.linkedin.com/in/imad-ehsan"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          {/* WhatsApp Link */}
          <a
            href="https://wa.me/923184614840?text=Hi%20there!%20I%20found%20you%20through%20your%20website"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          {/* Call Link */}
          <a href="tel:+923184614840" target="_blank" rel="noopener noreferrer">
            <img src={call} alt="+923184614840" className="link" />
          </a>
        </div>
      </div>
